...
export const projects = [
    {
      name: "Name origin",
      description: "a web app that uses an api from a machine learning algorithm from nationalize.io to displays the origin of your name, its probable accuracy and other information about the origin country.",
