...
export default function Card({image, title,description,tools}) {
  return (
    <div className=' flex text-center flex-col items-center shadow-lg shadow-teal-900 border-separate pd-10 rounded-xl my-10 hover:-translate-y-1 hover:scale-110 duration-300  dark:bg-gray-100 dark:shadow-teal-700'>
